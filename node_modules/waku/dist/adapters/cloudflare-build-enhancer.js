...
async function postBuild({ distDir, DIST_PUBLIC, serverless }) {
...
`);
    ...
    if (!fs.existsSync(wranglerTomlFile) && !fs.existsSync(wranglerJsonFile) && !fs.existsSync(wranglerJsoncFile)) {
        ...
        fs.writeFileSync(wranglerJsoncFile, `\
{
  "$schema": "node_modules/wrangler/config-schema.json",
  "name": ${JSON.stringify(projectName)},
  ${serverless ? `"main": ${JSON.stringify(forceRelativePath(path.relative(process.cwd(), mainEntry)))},
  ...
  "assets": {
    ${serverless ? `// https://developers.cloudflare.com/workers/static-assets/binding/
    "binding": "ASSETS",
