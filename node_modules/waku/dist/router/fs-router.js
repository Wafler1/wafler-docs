   ...
   */ pages, options = {
    ...
    if (!didWarnAboutApiDirMigration && !options.temporary_doNotWarnAboutApiDirMigration) {
        ...
        if (Object.keys(pages).some((file)=>file.startsWith('./api/'))) {
            console.warn('[fsRouter] Migration required (v1.0.0-alpha.1): Move "./api/" to "./_api/". To preserve the old "/api/*" URL paths, move to "./_api/api/". See https://github.com/wakujs/waku/pull/1885');
        }
    }
