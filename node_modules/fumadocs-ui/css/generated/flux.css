...
@source inline("all");
@source inline("and");
@source inline("animate");
@source inline("animate-fd-fade-in");
...
@source inline("bg-fd-background/60");
...
@source inline("flux-layout-slot");
...
@source inline("mode");
@source inline("motion");
@source inline("motion/react");
@source inline("ms-1");
...
@source inline("react-remove-scroll");
@source inline("ref");
@source inline("rel");
@source inline("relative");
@source inline("render");
@source inline("renderNavigationPanel");
...
@source inline("sm:bottom-6");
@source inline("sm:max-w-[380px]");
@source inline("sm:max-w-[400px]");
@source inline("sm:p-1");
@source inline("sm:rounded-2xl");
@source inline("space");
@source inline("span");
@source inline("spanProps");
